  ...
  return (
    <div className="text-sm border-[1px] border-dark_blue/20 rounded-md bg-white group">
      <div className="relative group overflow-hidden bg-shop_light_bg">
        ...
        {product?.status === "new" && (
          <p className=
          "absolute top-2 left-2 z-10 text-xs border border-darkColor/50 px-2 rounded-full group-hover:border-shop_light_green hoverEffect group-hover:text-shop_light_green">
            New!
          </p>
        )}
       ...
       {product?.status === "hot" && 
       <Link href={"/deal"}
             className="absolute top-2 z-10 border border-shop_orange/50 p-1 rounded-full group-hover:text-shop_orange hoverEffect">
              <Flame 
                size={18}
                fill="#fb6c08"
